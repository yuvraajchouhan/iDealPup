...
- In the page that appears, click the check boxes with the features you wwant to base on and press "Search With These Filters".
...
8. List of File Contents of Folder:
145-154          Files in the root folder
156-157          css (folder contains custom stylig for the compare page)
159-160          js (folder contains javascript for the filters page)
162-3607         node_modules (folder contains all node modules)
3609-3695        public (folder contains all images)
3697-3729        views (folder contains all ejs files)
